...
spawn(function() 
    ...
    wait(1.5)
    require(game.ReplicatedStorage.Notification).new("<Color=Red>vquygm chào ae<Color=/>"):Display()
    wait(.5)
...
local Window = OrionLib:MakeWindow({Name = "vquygm", HidePremium = false, IntroText = "vquygm⚜️", SaveConfig = true, ConfigFolder = "NightHub"})
...
W:AddLabel("vquygm SCRIPT")
W:AddLabel("Discordvquygm")
local Section = W:AddSection({
    Name = "Status"
})
